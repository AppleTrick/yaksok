...
OUTPUT_DIR = BASE_DIR.parent / "03_Dataset"

# 데이터 소스
SOURCES = {
    "original": BASE_DIR.parent.parent / "Legacy_History" / "Version2" / "01_Dataset" / "Medicine Detection.v1i.yolov11 (2)",
    "huseong": BASE_DIR.parent.parent / "01_collection" / "huseong",
    "huseong_labels": BASE_DIR.parent.parent / "01_collection" / "huseong" / "labels",
    "negative_samples": BASE_DIR.parent.parent / "01_collection" / "negative_samples",
    "sample_bg": BASE_DIR.parent.parent / "Legacy_History" / "Version2" / "01_Dataset" / "SAMPLE",
}
