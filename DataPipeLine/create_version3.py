...
OUTPUT_DIR = BASE_DIR / "Version3"

# 데이터 소스
SOURCES = {
    "original": BASE_DIR / "Version2" / "Medicine Detection.v1i.yolov11 (2)",
    "huseong": BASE_DIR / "huseong",
    "huseong_labels": BASE_DIR / "huseong" / "labels",
    "negative_samples": BASE_DIR / "negative_samples",
    "sample_bg": BASE_DIR / "Version2" / "SAMPLE",
}
