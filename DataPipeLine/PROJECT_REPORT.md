...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **V1 (Baseline)** | YOLOv11n | 520장 | - | - | - | 초기 데이터셋 구축, 기본 학습 |
| **V2 (Augmented)** | YOLOv11m | 1,250장 | - | - | - | 조명/각도 증강, 배경 이미지 추가 |
| **V3 (Final)** | **YOLOv11m** | **2,480장** | **0.921** | **0.730** | **0.814** | **Hard Negative Mining** (오탐지 감소), 라벨 정제 |
...
- **최종 결과**:
  - mAP@50 **0.814**, Precision **0.921**, Recall **0.730** (150 epochs)
